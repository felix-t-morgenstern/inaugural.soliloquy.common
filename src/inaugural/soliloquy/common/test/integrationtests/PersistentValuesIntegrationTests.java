...
public class PersistentValuesIntegrationTests extends TestCase {
	...
	public void testWriteValues()
    {
    	...
    	IPersistentValueToWrite persistentValueToWriteArchetype = new PersistentValueToWrite(null, null, null);
    	...
    	Boolean bool1 = true;
    	IPersistentValueToWrite bool1ToWrite = new PersistentValueToWrite(bool1.getClass().getCanonicalName(), "bool1", bool1);
    	persistentValuesToWrite.add(bool1ToWrite);
    	
    	Boolean bool2 = false;
    	IPersistentValueToWrite bool2ToWrite = new PersistentValueToWrite(bool2.getClass().getCanonicalName(), "bool2", bool2);
    	...
    	integers1.add(2);
    	integers1.add(3);
    	IPersistentValueToWrite integers1ToWrite = new PersistentValueToWrite(integers1.getParameterizedClassName(), "integers1", integers1);
    	...
    	integers2.add(5);
    	integers2.add(6);
    	IPersistentValueToWrite integers2ToWrite = new PersistentValueToWrite(integers2.getParameterizedClassName(), "integers2", integers2);
    	persistentValuesToWrite.add(integers2ToWrite);
    	
    	// Adding integer persistent values
    	Integer int1 = 123;
    	IPersistentValueToWrite int1ToWrite = new PersistentValueToWrite(int1.getClass().getCanonicalName(), "int1", int1);
    	persistentValuesToWrite.add(int1ToWrite);
    	
    	Integer int2 = 456;
    	IPersistentValueToWrite int2ToWrite = new PersistentValueToWrite(int2.getClass().getCanonicalName(), "int2", int2);
    	persistentValuesToWrite.add(int2ToWrite);
    	
    	Integer int3 = 789;
    	IPersistentValueToWrite int3ToWrite = new PersistentValueToWrite(int3.getClass().getCanonicalName(), "int3", int3);
    	persistentValuesToWrite.add(int3ToWrite);
    	
    	// Adding String persistent values
    	String string1 = "String1";
    	IPersistentValueToWrite string1ToWrite = new PersistentValueToWrite(string1.getClass().getCanonicalName(), "string1", string1);
    	persistentValuesToWrite.add(string1ToWrite);

    	String string2 = "String2";
    	IPersistentValueToWrite string2ToWrite = new PersistentValueToWrite(string2.getClass().getCanonicalName(), "string2", string2);
    	...
    	IPersistentValueToWrite strings1ToWrite = new PersistentValueToWrite(strings1.getParameterizedClassName(), "strings1", strings1);
    	...
    	IPersistentValueToWrite strings2ToWrite = new PersistentValueToWrite(strings2.getParameterizedClassName(), "strings2", strings2);
