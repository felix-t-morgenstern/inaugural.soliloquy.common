...
class GenericParamsSetImplTests {
	private GenericParamsSetImpl _genericParamsSet;
	private Map<String,Integer> _mapOfInts;
	private Map<String,Integer> _mapOfInts2;
	private Map<String,Boolean> _mapOfBooleans;
	...
	void setUp() {
    	...
    	_genericParamsSet = new GenericParamsSetImpl(new GenericParamsSetPersistentValuesHandlerStub(),
    			MAP_FACTORY);
    }
	...
	void testGetNullParamsSet() {
    	Map<String,Integer> paramsSet = _genericParamsSet.getParamsSet(Integer.class.getCanonicalName());
    ...
    @Test
	void testParamTypes() {
    	Collection<String> paramTypes = _genericParamsSet.paramTypes();
	...
	void testMakeClone() {
    	...
    	GenericParamsSet cloned = _genericParamsSet.makeClone();

		assertEquals(2, cloned.paramTypes().size());
    	
    	Map<String,Integer> intParams = cloned.getParamsSet(Integer.class.getCanonicalName());
		assertEquals(2, intParams.size());
		assertEquals(1, (int) intParams.get("Int_Param_1"));
		assertEquals(2, (int) intParams.get("Int_Param_2"));
    	
    	Map<String,Boolean> boolParams = cloned.getParamsSet(Boolean.class.getCanonicalName());
